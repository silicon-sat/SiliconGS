...
2. **Antenna design**:
   - Design a **quarter-wave ground-plane antenna**, ideal for the 433 MHz frequency used by LoRa.
...
**For example, for a frequency of 433 MHz**:
 Explanation:
 Wavelength (lambda) of a radio wave is the distance it travels in one cycle and is given by 
